...
import { useMyPersonalInformationQuery } from '../generated/graphql';
...
const Account: FC = () => {
  ...
  }, [loading, data, handleSignOut, t]);

  return <Grid gap={6} rounded={'lg'} bg={useColorModeValue('white', 'gray.700')} boxShadow={'lg'} p={8} width={'4xl'}>
    {renderBody}
  </Grid>;
};
